  ...
  parameters: {
    ...
    options: {
      storySort: {
        ...
        order: [
          'Welcome',
          ['Introduction', 'Why Design Systems', 'Design Principles'],
          'Getting Started',
          ['Installation', 'Usage Guide', 'For Designers'],
          'Foundation',
          ['Colors', 'Typography', 'Spacing & Layout', 'Shadows & Elevation', 'Border Radius', 'Motion & Animation', 'Icons'],
          'Theming',
          ['Overview', 'Token Architecture', 'Dark Mode', 'Creating Custom Themes'],
          'Patterns',
          ['RTL Development', 'Bidirectional Typography', 'Accessibility', 'Form Patterns', 'Composition'],
          'Architecture',
          ['Technical Overview', 'Primitive-Agnostic Design', 'Internationalization', 'GCC-Specific Components', 'AI Components'],
          'Basic',
          'Forms',
          'Navigation & Layout',
          'Data Display',
