...
const componentCategories = (t: typeof content.en | typeof content.ar) => [
  ...
  },
  {
    ...
    components: [
      { name: 'Button', icon: Cursor, href: '/components/button', status: 'ready' },
      { name: 'ButtonArrow', icon: CaretRight, href: '/components/button-arrow', status: 'ready' },
      ...
      { name: 'Input', icon: TextT, href: '/components/input', status: 'ready' },
      { name: 'Label', icon: Tag, href: '/components/label', status: 'ready' },
      { name: 'Badge', icon: Tag, href: '/components/badge', status: 'ready' },
      { name: 'Separator', icon: Stack, href: '/components/separator', status: 'ready' },
  ...
  },
  {
    ...
    components: [
      ...
      { name: 'Select', icon: List, href: '/components/select', status: 'ready' },
      ...
      { name: 'Textarea', icon: TextT, href: '/components/textarea', status: 'ready' },
    ],
  },
  {
    ...
    components: [
      ...
      { name: 'Blockquote', icon: Quotes, href: '/components/blockquote', status: 'ready' },
      { name: 'Pull Quote', icon: Quotes, href: '/components/pull-quote', status: 'ready' },
    ],
  },
  {
    ...
    components: [
      { name: 'Alert', icon: WarningCircle, href: '/components/alert', status: 'ready' },
      { name: 'Callout', icon: Lightbulb, href: '/components/callout', status: 'ready' },
      { name: 'Toast', icon: ChatCentered, href: '/components/toast', status: 'ready' },
      { name: 'Dialog', icon: ChatCentered, href: '/components/dialog', status: 'ready' },
      { name: 'Tooltip', icon: Info, href: '/components/tooltip', status: 'ready' },
      { name: 'Progress', icon: SpinnerGap, href: '/components/progress', status: 'ready' },
      { name: 'Skeleton', icon: SpinnerGap, href: '/components/skeleton', status: 'ready' },
      { name: 'Empty State', icon: Tray, href: '/components/empty-state', status: 'ready' },
    ],
  },
  {
    ...
    components: [
      { name: 'Tabs', icon: List, href: '/components/tabs', status: 'ready' },
      { name: 'Breadcrumb', icon: House, href: '/components/breadcrumb', status: 'ready' },
      { name: 'Pagination', icon: CaretRight, href: '/components/pagination', status: 'ready' },
      { name: 'Dropdown Menu', icon: List, href: '/components/dropdown-menu', status: 'ready' },
      { name: 'Context Menu', icon: List, href: '/components/context-menu', status: 'ready' },
    ],
  },
  {
    ...
    components: [
      { name: 'Sheet', icon: SidebarSimple, href: '/components/sheet', status: 'ready' },
      { name: 'Accordion', icon: CaretUpDown, href: '/components/accordion', status: 'ready' },
      { name: 'Collapsible', icon: CaretUpDown, href: '/components/collapsible', status: 'ready' },
      { name: 'Popover', icon: ChatCentered, href: '/components/popover', status: 'ready' },
    ],
  },
  {
    ...
    components: [
      ...
      { name: 'Rich Text Editor', icon: NotePencil, href: '/components/rich-text-editor', status: 'ready' },
      ...
      { name: 'Number Input', icon: NumberSquareZero, href: '/components/number-input', status: 'ready' },
  ...
  },
  {
    ...
    components: [
      { name: 'Chat Message', icon: ChatCentered, href: '/components/chat-message', status: 'ready' },
      { name: 'Prompt Input', icon: PaperPlaneTilt, href: '/components/prompt-input', status: 'ready' },
      { name: 'Thinking Indicator', icon: SpinnerGap, href: '/components/thinking-indicator', status: 'ready' },
      { name: 'Message Actions', icon: Gear, href: '/components/message-actions', status: 'ready' },
      { name: 'Model Selector', icon: Sparkle, href: '/components/model-selector', status: 'ready' },
