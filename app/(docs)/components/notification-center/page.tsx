...
export default function NotificationCenterPage() {
  ...
  const [notifications1, setNotifications1] = React.useState<Notification[]>([
    {
      id: '1',
      title: content.en.notificationCenterComponent.demoNotifications.newComment,
      titleAr: content.ar.notificationCenterComponent.demoNotifications.newComment,
      description: content.en.notificationCenterComponent.demoNotifications.sarahComment,
    ...
    {
      id: '2',
      title: content.en.notificationCenterComponent.demoNotifications.newFollower,
      titleAr: content.ar.notificationCenterComponent.demoNotifications.newFollower,
      description: content.en.notificationCenterComponent.demoNotifications.ahmedFollowing,
      descriptionAr: content.ar.notificationCenterComponent.demoNotifications.ahmedFollowing,
    ...
    {
      id: '3',
      title: content.en.notificationCenterComponent.demoNotifications.someoneLiked,
      titleAr: content.ar.notificationCenterComponent.demoNotifications.someoneLiked,
      description: content.en.notificationCenterComponent.demoNotifications.peopleLikedReact,
      descriptionAr: content.ar.notificationCenterComponent.demoNotifications.peopleLikedReact,
  ...
  const [notifications2, setNotifications2] = React.useState<Notification[]>([
    {
      id: '1',
      title: content.en.notificationCenterComponent.demoNotifications.newReview,
      titleAr: content.ar.notificationCenterComponent.demoNotifications.newReview,
      description: content.en.notificationCenterComponent.demoNotifications.excellentService,
      descriptionAr: content.ar.notificationCenterComponent.demoNotifications.excellentService,
      time: new Date(Date.now() - 10 * 60000).toISOString(),
      read: false,
      icon: <Star className="h-5 w-5" />,
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=John',
