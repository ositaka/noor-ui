  ...
  return (
    ...
    >
      <ProgressPrimitive.Indicator
        className="h-full w-full flex-1 bg-gradient-to-r from-primary via-primary/80 to-primary transition-all duration-500 ease-in-out relative overflow-hidden rtl:bg-gradient-to-l"
