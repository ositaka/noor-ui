...
nav: {
    ...
    storybook: {
      ...
      description: 'استكشف 749 قصة تفاعلية عبر 74 مكونًا. بدّل بين RTL/LTR، وجرّب سمات مختلفة، واختبر إمكانية الوصول—كل ذلك في متصفحك.',
...
common: {
  ...
  startersPage: {
    ...
    sections: {
      ...
      copyCustomizeDesc: 'انسخ المجلد، خصّصه حسب احتياجاتك، وانشر في دقائق.',
