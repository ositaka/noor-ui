...
tableComponent: {
      ...
      compositionPattern: {
        ...
        table: 'الحاوية الرئيسية مع معالجة التجاوز',
      ...
      examples: {
        ...
        striped: 'صفوف مخططة',
        hoverable: 'صفوف مع تأثير التحويم',
...
collapsibleComponent: {
      ...
      composition: {
        intro: 'يتبع مكون القابل للطي نمط تركيب مع ثلاثة مكونات فرعية:',
        collapsible: 'المكون الجذر الذي يدير الحالة',
        trigger: 'زر للتبديل بين الفتح/الإغلاق',
        content: 'المحتوى الذي ينطوي/يتوسع',
      },
      examples: {
        title: 'أمثلة',
        basic: 'أساسي',
        ...
        previewQuestion: 'هل يمكنني استخدام هذا في مشروعي؟',
        previewAnswer: 'نعم! هذا المكون مجاني ومفتوح المصدر. يمكنك استخدامه في أي مشروع، تجاري أو شخصي.',
        hide: 'إخفاء',
        show: 'إظهار',
        details: 'التفاصيل',
        controlledDescription: 'هذا القابل للطي متحكم به، مما يعني أنك تدير حالة الفتح. يدور السهم بسلاسة عند التبديل.',
        starredRepositories: 'المستودعات المميزة',
        toggle: 'تبديل',
        repo1: 'نظام التصميم RTL',
        repo2: 'مكونات React',
        repo3: 'أدوات TypeScript',
        faq1Q: 'ما هو نظام التصميم هذا؟',
        faq1A: 'نظام تصميم RTL أولاً مبني لسوق دول مجلس التعاون الخليجي مع دعم ثنائي اللغة بالكامل.',
        faq2Q: 'كيف أقوم بتثبيته؟',
        faq2A: 'شغّل npm install noorui-rtl ببساطة واستورد المكونات التي تحتاجها.',
        faq3Q: 'هل يمكن الوصول إليه؟',
        faq3A: 'نعم! جميع المكونات متوافقة مع WCAG AA مع التنقل الكامل بلوحة المفاتيح.',
      },
      props: {
        title: 'الخصائص',
        ...
        radixNote: 'هذا المكون مبني على أساس Radix UI Collapsible. للحصول على خصائص إضافية، راجع',
        radixLink: 'وثائق Radix UI',
      },
      accessibility: {
        title: 'إمكانية الوصول',
        keyboardNavigation: 'التنقل بلوحة المفاتيح',
        toggleWhenFocused: 'يبدل القابل للطي عندما يكون المشغل في التركيز',
        ariaAttributes: 'سمات ARIA',
        ariaDescription: 'يدير المكون تلقائيًا aria-expanded و aria-controls لمستخدمي قارئ الشاشة. يتواصل زر المشغل ما إذا كان المحتوى موسعًا أو منطويًا حاليًا.',
        visualIndicators: 'مؤشرات بصرية',
        visualDescription: 'أضف دائمًا مؤشرًا بصريًا (مثل أيقونة السهم) يوضح الحالة الحالية. حرّك المؤشر لتقديم تعليقات عند تغيير الحالة.',
      },
      rtl: {
        title: 'اعتبارات RTL',
      ...
      related: {
        title: 'المكونات ذات الصلة',
        accordion: 'قوابل طي متعددة مع سلوك فتح واحد',
        tabs: 'تنظيم المحتوى في أقسام مبوبة',
        dialog: 'مربعات حوار مشروطة للمحتوى المركّز',
      },
    },
...
tabsComponent: {
      ...
      demo: {
        account: 'الحساب',
        accountDesc: 'عدّل حسابك من هنا. انقر على حفظ عند الانتهاء.',
        password: 'كلمة المرور',
        passwordDesc: 'غيّر كلمة مرورك هنا. بعد الحفظ، سيتم تسجيل خروجك.',
        settings: 'الإعدادات',
