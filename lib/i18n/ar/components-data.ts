...
collapsibleComponent: {
      ...
      examples: {
        ...
        faq2A: 'ببساطة قم بتشغيل npm install noorui-rtl واستورد المكونات التي تحتاجها.',
      ...
      accessibility: {
        ...
        visualDescription: 'قم دائمًا بتضمين مؤشر بصري (مثل أيقونة السهم) يوضح الحالة الحالية. قم بتحريك المؤشر لتقديم تعليقات عند تغيير الحالة.',
      },
      rtl: {
        title: 'اعتبارات RTL',
