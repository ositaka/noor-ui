...
thinkingIndicatorComponent: {
  ...
  notificationCenterComponent: {
    ...
    bestPractices: {
      doList: [
        'اعرض الإشعارات غير المقروءة بشكل بارز',
        'قم بتضمين الطوابع الزمنية لجميع الإشعارات',
        'وفر إجراءات واضحة (وضع علامة مقروء، حذف)',
        'قم بتجميع الإشعارات حسب الفئة أو التاريخ',
        'اعرض شارة عدد الإشعارات في واجهة المستخدم',
      ],
      dontList: [
        'لا تطغى على المستخدمين بعدد كبير جدًا من الإشعارات في آن واحد',
        'لا تحذف الإشعارات بدون تأكيد المستخدم',
        'لا تستخدم رسائل إشعار غير واضحة أو عامة',
        'لا تنس التعامل مع الحالات الفارغة بشكل جيد',
        'لا ترفض الإشعارات المهمة تلقائيًا بسرعة كبيرة',
      ],
    },
  },
