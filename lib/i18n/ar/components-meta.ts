...
components: {
      title: 'المكونات',
      description: '77 مكوّن مصمم بشكل جميل باستخدام Radix UI و Tailwind CSS و React Flow. دعم كامل لاتجاه النص، قابل للوصول، وقابل للتخصيص.',
      ...
      categories: {
        ...
        gccDesc: 'مكونات للتطبيقات الإسلامية والسياقات العربية',
