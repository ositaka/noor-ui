...
export const getting_started = {
  gettingStarted: {
    ...
    prerequisiteTypescript: 'TypeScript 5+ (recommended)',
    configuration: 'Configuration',
    tailwindConfig: 'Tailwind Configuration',
    tailwindConfigDesc: 'Configure Tailwind CSS v4 to work with Noor UI using the CSS-first approach. Design tokens and theme configuration are defined directly in your CSS file.',
    important: 'Important',
    tailwindImportantNote: 'Tailwind v4 uses automatic content detection — no content array is needed. Just make sure noorui-rtl is installed and your CSS imports @import "tailwindcss".',
